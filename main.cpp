        ...
        if (count >= 2)
        {
            ...
            if(MatrixLines==size)
            {
                ...
                while(true)
                {
                    ...
                    {
                        FivePossibleWays((MatrixElement *)FinalMatrix,&i,&j,size,&IndexHigher,&lasti,&lastj,&HowManySteps);
                        StepsOni.push_back(i);
                        StepsOnj.push_back(j);
                        HowManySteps++;
                    }
                    ...
                    {    
                        SouthEastPossibleWays((MatrixElement *)FinalMatrix,&i,&j,size,&IndexHigher,&lasti,&lastj,&HowManySteps);
                        StepsOni.push_back(i);
                        StepsOnj.push_back(j);
                        HowManySteps++;
                    }
                    ...
                    {
                        SouthWestPossibleWays((MatrixElement *)FinalMatrix,&i,&j,size,&IndexHigher,&lasti,&lastj,&HowManySteps);
                        StepsOni.push_back(i);
                        StepsOnj.push_back(j);
                        HowManySteps++;
                    }
